...
async function createSavableHtml(concept: GeneratedConcept & { prompt?: string }): Promise<string> {
  ...
  return `
    ...
    <head>
      ...
      <meta name="description" content="Created with MyPopku - The AI Mini App Generator.">
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    if (body.html && body.css && body.js && body.explanation) {
      ...
      htmlContent = await createSavableHtml(conceptData);
